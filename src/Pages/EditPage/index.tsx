  ...
  useEffect(() => {
    if (isSuccess && data) {
      try {
        ...
        console.log('iyehvbiBGIB', data, data.response.data);
      } catch (e) {
        ...
        <Col xs={0} xl={24}>
          <Layout style={{ height: '100%' }}>
            <PageHeader
              ...
              avatar={{
                src: 'https://is2-ssl.mzstatic.com/image/thumb/Purple115/v4/20/4c/46/204c4688-66a5-d9ad-d4d1-017a72a91259/source/512x512bb.jpg',
                shape: 'square',
              }}
              extra={[
                <>
