...
const ColumnSelector = () => {
  ...
  const [numberOfCustomColumns, setNumberOfCustomColumns] = useState<number>(4);
  ...
  useEffect(() => {
    ...
    setVisible(false);
    setNumberOfCustomColumns(4);
  }, [active, visible]);

  useEffect(() => {
    console.log('numberOfCustomColumns', numberOfCustomColumns);
    console.log('Clicked image', new Array(numberOfCustomColumns).fill(`${100 / numberOfCustomColumns}%`));
    handleClick(new Array(numberOfCustomColumns).fill(`${100 / numberOfCustomColumns}%`));
  ...
  return visible ? (
    <>
      ...
      <div style={{ marginTop: '16px' }}>
        ...
        <Image
          click={() => handleClick(['20%', '20%', '20%', '20%', '20%'])}
          one={10}
          two={10}
          three={10}
          four={10}
      ...
      <div style={{ marginTop: '16px' }}>
        ...
        <Image
          click={() => {
            // handleClick(['20%', '20%', '20%', '20%']);
            // handleClick([100/4,100/4,100/4,100/4,])
        ...
        <button
          onClick={() => {
            setNumberOfCustomColumns((el) => el + 1);
          }}
        >
          +{' '}
        </button>
      ...
      <SectionImage onClick={click ? click : undefined}>
        <div className="wrapper">
          <div className="border">
            ...
            {four ? <div style={{ ...style, flexGrow: four, borderRight: five ? borderRight : 'unset' }}></div> : null}
            {five ? (
              <div style={{ ...style, flexGrow: five, borderRight: custom ? borderRight : 'unset' }}></div>
            ) : null}
            {custom ? <div style={{ ...style, flexGrow: custom }}></div> : null}
          </div>
        </div>
      </SectionImage>
    </>
